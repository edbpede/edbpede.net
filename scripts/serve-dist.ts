 ...
 * and in CI.
 *
 * Serves dist/ the way the site is actually deployed — GitHub Pages under the
 * custom domain edbpede.net — including the directory-index and 404 behaviour
 * of a typical static host.
 *
