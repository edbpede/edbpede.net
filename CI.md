...
The site currently has no Svelte islands or unit-testable runtime logic. Existing Playwright checks cover navigation destinations, decoded assets, hover descriptions and zero shipped JavaScript.
